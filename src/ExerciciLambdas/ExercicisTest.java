...
public class ExercicisTest {

    @Test
    public void testHelloSupplier() {
        Supplier<String> helloSupplier = Exercicis.helloSupplier();
    ...
    public void testIsEmptyPredicate() {
        Predicate<String> isEmptyPredicate = Exercicis.isEmptyPredicate();
    ...
    public void testStringMultiplier() {
        BiFunction<String, Integer, String> stringMultiplier = Exercicis.stringMultiplier();
    ...
    public void testToDollarStringFunction() {
        Function<BigDecimal, String> toDollarStringFunction = Exercicis.toDollarStringFunction();
    ...
    public void testLengthInRangePredicate() {
        Predicate<String> lengthInRangePredicate = Exercicis.lengthInRangePredicate(4, 10);
    ...
    public void testRandomIntSupplier() {
        IntSupplier randomIntSupplier = Exercicis.randomIntSupplier();
    ...
    public void testBoundedRandomIntSupplier() {
        IntUnaryOperator boundedRandomIntSupplier = Exercicis.boundedRandomIntSupplier();
    ...
    public void testIntSquareOperation() {
        IntUnaryOperator squareOperation = Exercicis.intSquareOperation();
    ...
    public void testStringToIntConverter() {
        ToIntFunction<String> stringToIntConverter = Exercicis.stringToIntConverter();
    ...
    public void testNMultiplyFunctionSupplier() {
        Supplier<IntUnaryOperator> fiveMultiplyFunctionSupplier = Exercicis.nMultiplyFunctionSupplier(5);
    ...
    public void testComposeWithTrimFunction() {
        UnaryOperator<Function<String, String>> composeWithTrimFunction = Exercicis.composeWithTrimFunction();
    ...
    public void testRunningThreadSupplier() throws InterruptedException {
        ...
        Supplier<Thread> runningThreadSupplier = Exercicis.runningThreadSupplier(() -> concurrentLinkedQueue.add(25));
    ...
    public void testNewThreadRunnableConsumer() throws InterruptedException {
        Consumer<Runnable> newThreadRunnableConsumer = Exercicis.newThreadRunnableConsumer();
    ...
    public void testRunnableToThreadSupplierFunction() throws InterruptedException {
        Function<Runnable, Supplier<Thread>> runnableSupplierFunction = Exercicis.runnableToThreadSupplierFunction();
        Queue<Integer> concurrentLinkedQueue = new ConcurrentLinkedQueue<>();
    ...
    public void testFunctionToConditionalFunction() {
        BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> intFunctionToConditionalIntFunction
                = Exercicis.functionToConditionalFunction();
    ...
    public void testFunctionLoader() {
        BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader = Exercicis.functionLoader();
    ...
    public void testTrickyWellDoneSupplier() {
        Supplier<Supplier<Supplier<String>>> wellDoneSupplier = Exercicis.trickyWellDoneSupplier();

        String wellDoneStr = wellDoneSupplier.get().get().get();

        assertEquals("BEN FET!", wellDoneStr);
    }
}